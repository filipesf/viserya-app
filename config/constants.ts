...
if (!process.env.DISCORD_AUTH_KEY) throw new Error('DISCORD_AUTH_KEY is not set');
...
export const CLIENT_APPLICATION_ID = process.env.DISCORD_APP_ID!;
export const DISCORD_BOT_TOKEN = process.env.DISCORD_BOT_TOKEN!;
export const DISCORD_AUTH_KEY = process.env.DISCORD_AUTH_KEY!;
