...
export default function Voryn() {
  return (
    <>
      ...
      <p>
        To begin a new session, type the following command in the channel where
        you wish to play:
      </p>
      ...
      <p>
        ...
        You’ll need to do this before starting a new session in the same
        channel.
      </p>
      ...
      <p>
        ...
        customise your Discord server profile with the name of your character.
        This way, when Voryn parses the messages, it will ensure consistency on
        identify who you are. Discord has a built-in slash command to handle
        this for you:
      </p>
